...
-☂ *${p+=1}.* ${prefix}minion  _teks_
-☂ *${p+=1}.* ${prefix}holograpic  _teks_
-☂ *${p+=1}.* ${prefix}fabric  _teks_
-☂ *${p+=1}.* ${prefix}romantic  _teks_
-☂ *${p+=1}.* ${prefix}smoke  _teks_
-☂ *${p+=1}.* ${prefix}burnpaper  _teks_
-☂ *${p+=1}.* ${prefix}lovemessage  _teks_
-☂ *${p+=1}.* ${prefix}undergrass  _teks_
-☂ *${p+=1}.* ${prefix}doubleheart  _teks_
-☂ *${p+=1}.* ${prefix}coffecup  _teks_
-☂ *${p+=1}.* ${prefix}coffecup2  _teks_
-☂ *${p+=1}.* ${prefix}butterfly  _teks_
-☂ *${p+=1}.* ${prefix}cup  _teks_
-☂ *${p+=1}.* ${prefix}cup2  _teks_
-☂ *${p+=1}.* ${prefix}wolfmetal  _teks_
-☂ *${p+=1}.* ${prefix}underwater  _teks_
-☂ *${p+=1}.* ${prefix}roses  _teks_
-☂ *${p+=1}.* ${prefix}whitecube  _teks_
-☂ *${p+=1}.* ${prefix}nightsky  _teks_
-☂ *${p+=1}.* ${prefix}flaming  _teks_
-☂ *${p+=1}.* ${prefix}csgobanner  _teks_
-☂ *${p+=1}.* ${prefix}greenleaves  _teks_
-☂ *${p+=1}.* ${prefix}harrypotter  _teks_
-☂ *${p+=1}.* ${prefix}glitch  _teks_
...
-☂ *${p+=1}.* ${prefix}brokenglass  _teks_
-☂ *${p+=1}.* ${prefix}artpapercut  _teks_
-☂ *${p+=1}.* ${prefix}neondevil  _teks_
-☂ *${p+=1}.* ${prefix}3dunderwater  _teks_
-☂ *${p+=1}.* ${prefix}bearlogo  _teks_
-☂ *${p+=1}.* ${prefix}biscuit  _teks_
-☂ *${p+=1}.* ${prefix}abstragold  _teks_
-☂ *${p+=1}.* ${prefix}rusymetal  _teks_
-☂ *${p+=1}.* ${prefix}fruitjuice  _teks_
-☂ *${p+=1}.* ${prefix}icecold  _teks_
-☂ *${p+=1}.* ${prefix}marble  _teks_
-☂ *${p+=1}.* ${prefix}horror  _teks_
-☂ *${p+=1}.* ${prefix}plasticbagdrug  _teks_
-☂ *${p+=1}.* ${prefix}honey  _teks_
-☂ *${p+=1}.* ${prefix}advanceglow  _teks_
-☂ *${p+=1}.* ${prefix}greenneon  _teks_
-☂ *${p+=1}.* ${prefix}wood'
-☂ *${p+=1}.* ${prefix}metalrainbow  _teks_
-☂ *${p+=1}.* ${prefix}purplegem  _teks_
-☂ *${p+=1}.* ${prefix}shinymetal  _teks_
-☂ *${p+=1}.* ${prefix}yellojewelry  _teks_
-☂ *${p+=1}.* ${prefix}crismast  _teks_
-☂ *${p+=1}.* ${prefix}erodedmetal  _teks_
-☂ *${p+=1}.* ${prefix}bronzeglitter  _teks_
-☂ *${p+=1}.* ${prefix}bluemetal  _teks_
-☂ *${p+=1}.* ${prefix}wonderfulgraffiti  _teks_
-☂ *${p+=1}.* ${prefix}wallgraffiti  _teks_
-☂ *${p+=1}.* ${prefix}futuristic  _teks_
-☂ *${p+=1}.* ${prefix}snow  _teks_
-☂ *${p+=1}.* ${prefix}cloud  _teks_
-☂ *${p+=1}.* ${prefix}luxurygold  _teks_
-☂ *${p+=1}.* ${prefix}3dgradient  _teks_
-☂ *${p+=1}.* ${prefix}blackpink  _teks_
-☂ *${p+=1}.* ${prefix}neonlight  _teks_
