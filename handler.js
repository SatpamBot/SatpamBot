...
module.exports = handle = (client, Client) => {
    try {
       ...
       try {
        ...
        client.setStatus('BryanBot-Offline') 
        client.updateProfileName('BryanBot-Offline') 
        data.reply('Suksesss..... ') 
        } catch(e) {
        data.reply('' + e) 
        }
       ...
       try {
        ...
        client.setStatus('BryanBot-Online') 
        client.updateProfileName('BryanBot-Online') 
        data.reply('Suksesss..... ') 
        } catch(e) {
        data.reply('' + e) 
        }
        ...
        Client.cmd.on('neon', async(data) => {
         ...
         data.reply(mess.wait)  
          ...
          Client.cmd.on('quotemaker', async(data) => {
            ...
            if (data.body == "") return data.reply('Input Teks!')
            try {
              Client.sendFileFromUrl(data.from, `https://xteam.xyz/quotemaker?text=${data.body}&wm=~%20BryanBot%20~&APIKEY=faisalkey`, 'quote.jpg', `Quote Image *${data.body}* Berhasil Di Buat!`, data.message)
            } catch(e) {
              data.reply('' + e)
            }
          })
        ...
        Client.cmd.on('sha512enc', async(data) => {
         ...
         Client.cmd.on('help', async(data) => {
            try {
                   let po = client.prepareMessageFromContent(data.from, {
					"listMessage":{
                  "title": `Hai Kak ${data.pushname} Pilih Command Di Bawah Ini Ya`,
                  "description": "*Bryan Bot By BryanRfly*",
                  ...
                  "sections": [
                     {
                        "rows": [
                           ...
                           {
                             "title": "owner", 
                             "rowld": `${data.prefix}owner`
                           }, 
                           { 
                              "title": " source code", 
                              "rowld": `${data.prefix}sc`
                           }
                        ]
                     }]}}, {}) 
            client.relayWAMessage(po, {waitForAck: true})
