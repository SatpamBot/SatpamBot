...
module.exports = handle = (client, Client) => {
    try {
        ...
        Client.cmd.on('mediafire', async(data) => {
          ...
          if (data.body == "") return data.reply('input link')
          try {
            mdfr = await axios.get(`https://xteam.xyz/dl/mediafire?url=${data.body}&APIKEY=${xkey}`)
        ...
        Client.cmd.on('soundcloud', async(data) => {
          ...
          if (data.body == "") return data.reply('Input Link!')
          try {
            sndc = await axios.get(`https://xteam.xyz/dl/soundcloud?url=${data.body}&APIKEY=${xkey}`)
...
`
        ...
        Client.cmd.on('poly', async(data) => {
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/poly?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
           } catch(e) {
          data.reply(''+e) 
          }
        })
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/gold?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
          } catch(e) {
          data.reply(''+e) 
          }
        }) 
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/glowing?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
           } catch(e) {
          data.reply(''+e) 
          }
        })
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/colorful?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
           } catch(e) {
          data.reply(''+e) 
          }
        }) 
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/army?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
           } catch(e) {
          data.reply(''+e) 
          }
        }) 
          ...
          if (data.body == "") return data.reply('Input Teks')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/videomaker/retro?text=${data.body}&APIKEY=${xkey}`, 'poly.mp4', 'nih', data.message)
           } catch(e) {
          data.reply(''+e) 
          }
        })
        ...
        Client.cmd.on('neon', async(data) => {
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/neon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/cloudtext?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/3dluxury?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/3dgradient?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/blackpink?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/realisticcloud?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/cloudsky?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/sandsummerbeach?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
         data.reply(mess.wait)  
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/sandengraved?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/sandwriting?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/balloontext?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/3dglue?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/space3d?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/metaldarkgold?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/neongalaxy?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/1917?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/minion3d?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/ultragloss?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/glossycarbon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/deluxegold?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/glossybluemetal?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/deluxesilver?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/metalpurpledual?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/holographic3d?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/purplefoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/fabric?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/stone?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/redfoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/cyanfoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/pinkfoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/greenfoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/bluefoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/yellowfoilballon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/greenglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/redglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/blueglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/purpleglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/cyanglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/orangeglass?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/decorategreen?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/decorateyellow?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/fireworksparkle?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/greenneon?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/bokeh?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/honey?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/advancedglow?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/scifi?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/begel?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          if (data.body == "") return data.reply('Input Teks!')
          try {
          Client.sendFileFromUrl(data.from, `https://xteam.xyz/textpro/biscuit?text=${data.body}&APIKEY=${xkey}`, 'textpro.jpg', `Nih Kak @${data.sender.split('@')[0]} Udah Jadi`, data.message)
          data.reply(mess.wait) 
          } catch(e) {
            data.reply('' + e) 
          }
          ...
          Client.cmd.on('quotemaker', async(data) => {
            ...
            if (data.body == "") return data.reply('Input Teks!')
            try {
              Client.sendFileFromUrl(data.from, `https://xteam.xyz/quotemaker?text=${data.body}&wm=~%20${configs.botname}%20~&APIKEY=${xkey}`, 'quote.jpg', `Quote Image *${data.body}* Berhasil Di Buat!`, data.message)
            } catch(e) {
              data.reply('' + e)
            }
          })
        ...
        Client.cmd.on('base64', async(data) => {
          ...
          axios.get(`https://xteam.xyz/encrypt/b64enc?text=${data.args[1]}&APIKEY=${xkey}`)
          .then(res => {
            data.reply(res.data.result)
          })
          .catch(e => {
            ...
            axios.get(`https://xteam.xyz/encrypt/b64dec?text=${data.args[1]}&APIKEY=${xkey}`)
            .then(res => {
              data.reply(res.data.result)
            })
            .catch(e => {
         ...
         Client.cmd.on('base32', async(data) => {
           ...
           if (data.args[0].toLowerCase() == 'encrypt') {
             axios.get(`https://xteam.xyz/encrypt/b32enc?text=${data.args[1]}&APIKEY=${xkey}`)
             .then(res => {
               data.reply(res.data.result)
             })
             .catch(e => {
             ...
             axios.get(`https://xteam.xyz/encrypt/b32dec?text=${data.args[1]}&APIKEY=${xkey}`)
             .then(res => {
               data.reply(res.data.result)
             })
             .catch(e => {
         ...
         Client.cmd.on('sha1enc', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
           if (data.body == "") return data.reply('Input Teks!')
           axios.get(`https://xteam.xyz/encrypt/sha1?text=${data.body}&APIKEY=${xkey}`)
           .then(res => {
      ...
      Client.cmd.on('sha256enc', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
           if (data.body == "") return data.reply('Input Teks!')
           axios.get(`https://xteam.xyz/encrypt/sha256?text=${data.body}&APIKEY=${xkey}`)
           .then(res => {
             data.reply(res.data.result.encrypt)
           }) 
           .catch(e => {
        ...
        Client.cmd.on('sha512enc', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
           if (data.body == "") return data.reply('Input Teks!')
           axios.get(`https://xteam.xyz/encrypt/sha512?text=${data.body}&APIKEY=${xkey}`)
           .then(res => {
             data.reply(res.data.result.encrypt)
           }) 
           .catch(e => {
         ...
         Client.cmd.on('cecan', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/cewe?APIKEY=${xkey}`, 'cecan.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         })
          ...
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/cowo?APIKEY=${xkey}`, 'cogan.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         })
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/cewe?APIKEY=${xkey}`, 'bts.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/exo?APIKEY=${xkey}`, 'exo.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/shota?APIKEY=${xkey}`, 'shota.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/meme2?APIKEY=${xkey}`, 'meme2.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/darkjoke?APIKEY=${xkey}`, 'darkjoke2.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
          Client.cmd.on('manga', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/manga?APIKEY=${xkey}`, 'manga.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
          Client.cmd.on('neko', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/nsfwneko?APIKEY=${xkey}`, 'nekocrot.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
          Client.cmd.on('uniform', async(data) => {
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/uniform?APIKEY=${xkey}`, 'y.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
           ...
           if (isLimit(data.sender)) return data.reply(mess.limit)
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/husbu2?APIKEY=${xkey}`, 'husbu.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
          ...
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/blowjob?APIKEY=${xkey}`, 'sange.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         }) 
          ...
          try {
            Client.sendFileFromUrl(data.from, `https://xteam.xyz/randomimage/pussy?APIKEY=${xkey}`, 'sange.jpg', `Ini Kak Random Image Nya`, data.message) 
          } catch(e) {
            data.reply('' + e)
          }
         })
          ...
          sec.push({
            ...
            Client.sendContact(data.from, { number: configs.ownerList[0].split('@')[0], name: `Owner ${configs.botname}` }, data.message)
              ...
              Client.cmd.on('pizzahut', async(data) => {
                ...
                axios.get(`https://xteam.xyz/spammer/pizzahut?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
                ...
                if (data.body == "") return data.reply('Input Nomor!')
                if (data.args[0].startsWith('08')) return data.reply('Gunakan Kode Negara!')
                axios.get(`https://xteam.xyz/spammer/olx?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
                ...
                if (data.body == "") return data.reply('Input Nomor!')
                if (data.args[0].startsWith('08')) return data.reply('Gunakan Kode Negara!')
                axios.get(`https://xteam.xyz/spammer/jagreward?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
                ...
                if (data.body == "") return data.reply('Input Nomor!')
                if (data.args[0].startsWith('08')) return data.reply('Gunakan Kode Negara!')
                axios.get(`https://xteam.xyz/spammer/danacita?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
                ...
                if (data.body == "") return data.reply('Input Nomor!')
                if (data.args[0].startsWith('08')) return data.reply('Gunakan Kode Negara!')
                axios.get(`https://xteam.xyz/spammer/lcq?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
                ...
                if (data.body == "") return data.reply('Input Nomor!')
                if (data.args[0].startsWith('08')) return data.reply('Gunakan Kode Negara!')
                axios.get(`https://xteam.xyz/spammer/allspam?no=${data.body}&APIKEY=${xkey}`)
                .then(res => {
                  data.reply(JSON.stringify(res.data, null, 2))
                })
                .catch(e => {
              ...
              if (data.body == "") return data.reply('Input Link') 
              axios.get(`https://xteam.xyz/shorturl/bitly?url=${data.body}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              if (data.body == "") return data.reply('Input Link') 
              axios.get(`https://xteam.xyz/shorturl/cutly?url=${data.body}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              p = data.body
              txt = p.split('|')
              axios.get(`https://xteam.xyz/shorturl/customcuttly?url=${txt[0]}&nama=${txt[1]}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              p = data.body
              txt = p.split('|')
              axios.get(`https://xteam.xyz/shorturl/gg?url=${txt[0]}&nama=${txt[1]}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              if (data.body == "") return data.reply('Input Link') 
              axios.get(`https://xteam.xyz/shorturl/tinyurl?url=${data.body}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              if (data.body == "") return data.reply('Input Link') 
              axios.get(`https://xteam.xyz/shorturl/shorturlat?url=${data.body}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
             data.reply('' + e) 
              ...
              if (data.body == "") return data.reply('Input Link') 
              axios.get(`https://xteam.xyz/shorturl/sid?url=${data.body}&APIKEY=${xkey}`) 
              .then(res => {
             data.reply(JSON.stringify(res.data.result, null, 2)) 
             }) 
             .catch(e => {
            ...
            switch(command.toLowerCase()) {
                ...
                case 'snobg':
                    ...
                    case 'magernulis1':
                      if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
                      Client.sendFileFromUrl(data.from, `https://xteam.xyz/magernulis2?text=${data.body}&APIKEY=${xkey}`, 'nulis.jpg', `Semangat Belajar Kak @${data.sender.split('@')[0]}`, data.mesage)
                      break 
                       case 'nulis2':
                    case 'magernulis2':
                      if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
                      Client.sendFileFromUrl(data.from, `https://xteam.xyz/magernulis3?text=${data.body}&APIKEY=${xkey}`, 'nulis.jpg', `Semangat Belajar Kak @${data.sender.split('@')[0]}`, data.mesage)
                      break 
                       case 'nulis3':
                    case 'magernulis3':
                      if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
                      Client.sendFileFromUrl(data.from, `https://xteam.xyz/magernulis4?text=${data.body}&APIKEY=${xkey}`, 'nulis.jpg', `Semangat Belajar Kak @${data.sender.split('@')[0]}`, data.mesage) 
                      break 
                       case 'nulis4':
                    case 'magernulis4':
                      if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
                      Client.sendFileFromUrl(data.from, `https://xteam.xyz/magernulis5?text=${data.body}&APIKEY=${xkey}`, 'nulis.jpg', `Semangat Belajar Kak @${data.sender.split('@')[0]}`, data.mesage) 
                      break 
                      case 'nulis5':
                    case 'magernulis5':
                      if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
                      Client.sendFileFromUrl(data.from, `https://xteam.xyz/magernulis6?text=${data.body}&APIKEY=${xkey}`, 'nulis.jpg', `Semangat Belajar Kak @${data.sender.split('@')[0]}`, data.mesage) 
                      break       
...
`
                ...
                case 'jagokata':
                    ...
                    case 'momorhoki':
                    if (data.body == "") return data.reply('Input Nomor!') 
                    axios.get(`https://xteam.xyz/primbon/nomorhoki?no=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(res.data.result) 
                    }) 
                    break
                ...
                case 'artimimpi':
                    ...
                    case 'dewabetch':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/dewabatch?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
                    ...
                    case 'kusonime':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/kusonime?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
                    ...
                    case 'samehadaku':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/samehadaku?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
                    ...
                    case 'nekonime':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/nekonime?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
                    ...
                    case 'waifu':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/waifu?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
                    ...
                    case 'meganebuk':
                    if (data.body == "") return data.reply('Input Query') 
                    axios.get(`https://xteam.xyz/anime/meganebuk?q=${data.body}&APIKEY=${xkey}`) 
                    .then(res => {
                    data.reply(JSON.stringify(res.data, null, 2)) 
                    }) 
                    .catch(e => {
