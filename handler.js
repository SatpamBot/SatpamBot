    ...
    try {
        ...
        Client.cmd.on('tiktoknowm', async(data) => {
            if (isLimit(data.sender)) return data.reply(mess.limit) 
               ...
               Client.sendFileFromUrl(data.from, `https://dapuhy-api.herokuapp.com/api/socialmedia/tiktoknowm?url=${data.body}&apikey=ItsMeclient`, 'tiktok.mp4', `Video Berhasil Di Dapatkan@${data.sender.split('@')[0]}`,  data.message)
        })
        Client.cmd.on('tiktok', async(data) => {
            if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Query') 
          Client.sendFileFromUrl(data.from, `https://dapuhy-api.herokuapp.com/api/socialmedia/tiktokwithwm?url=${data.body}&apikey=ItsMeclient`, 'tiktod.mp4', `Video Berhasil Di Dapatkan @${data.sender.split('@')[0]}`, data.messsge)
        }) 
        ...
        Client.cmd.on('ytplay', async(data) => {
          if(isLimit(data.sender)) return data.reply(mess.limit)
          if(data.body == "") return data.reply('Input Link')
          res = await axios.get(`https://dapuhy-api.herokuapp.com/api/socialmedia/ytmp4v2?url=${data.body}&apikey=ItsMeclient`)
          result = res.data 
        ...
        Client.cmd.on('playyt', async(data) => {
          if(isLimit(data.sender)) return data.reply(mess.limit)
          if(data.body == "") return data.reply('Input Query')
          Client.sendFileFromUrl(data.from, `https://dapuhy-api.herokuapp.com/api/socialmedia/ytplaymp4v2?query=${data.body}&apikey=ItsMeclient`, 'playyt.mp4', 'Nih Kak', data.messsge)
        })
        ...
        Client.cmd.on('ig', async(data) => {
            if (isLimit(data.sender)) return data.reply(mess.limit) 
                      if (data.body == "") return data.reply('Input Link') 
                  Client.sendFileFromUrl(data.from, `https://dapuhy-api.herokuapp.com/api/socialmedia/igdownload?url=${data.body}&apikey=ItsMeclient`, 'ig.mp4',`Video Berhasil Di Dapatkan @${data.sender.split('@')[0]}`, data.message)
        })
       ...
       try {
        ...
        Client.cmd.on('asupan', async (data) => {
            ...
            if(data.args[0].toLowerCase() == 'ukhty') {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupanukhty?apikey=ItsMeclient', 'ukhty.mp4', `Nih Asupannya @${data.sender.split('@')[0]}`, data.message)
            } else if(data.args[0].toLowerCase() == 'santuy') {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupan?apikey=ItsMeclient', 'santuy.mp4', `Nih Kak @${data.sender.split('@')[0]} Asupannya`, data.message)
            } else if(data.args[0].toLowerCase() == '+62') {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupan?apikey=ItsMeclient', '+62.mp4',`Nih Kak @${data.sender.split('@')[0]} Asupannya`, data.message)
            } else if(data.args[0].toLowerCase() == 'bocil')  {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupanbocil?apikey=ItsMeclient', 'bocil.mp4', `Nih Kak @${data.sender.split('@')[0]} Asupannya`, data.message)
            } else if(data.args[0].toLowerCase() == 'rikagusriani') {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupanrikagusriani?apikey=ItsMeclient', 'rika.mp4', `Nih Kak @${data.sender.split('@')[0]} Asupannya`, data.message)
            } else if(data.args[0].toLowerCase() == 'ghea') {
              Client.sendFileFromUrl(data.from, 'https://dapuhy-api.herokuapp.com/api/asupan/asupanghea?apikey=ItsMeclient', 'ghea.mp4', `Nih Kak Asupannya`, data.message)
...
`
        ...
        Client.cmd.on('tahlil', async(data) => {
            if (isLimit(data.sender)) return data.reply(mess.limit) 
              axios.get('https://dapuhy-api.herokuapp.com/api/islam/tahlil?apikey=ItsMeclient') 
               .then(result => {
        ...
        Client.cmd.on('wirid', async(data) => {
          if(isLimit(data.sender)) return data.reply(mess.limit)
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/wirid?apikey=ItsMeclient')
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2))
          })
        })
        Client.cmd.on('asmaulhusna', async(data) => {
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/asmaulhusna?apikey=ItsMeclient')
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2)) 
          })
        })
        Client.cmd.on('doaharian', async (data) => {
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/doaharian?apikey=ItsMeclient') 
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2))
          })
        })
        Client.cmd.on('ayatkursi', async(data) => {
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/ayatkursi?apikey=ItsMeclient') 
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2))
          })
        }) 
        Client.cmd.on('kisahnabi', async(data) => {
          if(data.body == "") return data.reply('input query')
          res = await axios.get(`https://dapuhy-api.herokuapp.com/api/islam/kisahnabi?nabi=${data.body}&apikey=ItsMeclient`)
          hsl = res.data
          text = `Nama: ${data.body}\n`
        ...
        Client.cmd.on('niatsholat', async(data) => {
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/niatshalat?apikey=ItsMeclient')
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2))
          })
        })
        Client.cmd.on('bacaansholat', async(data) => {
          axios.get('https://dapuhy-api.herokuapp.com/api/islam/bacaanshalat?apikey=ItsMeclient')
          .then(res => {
            data.reply(JSON.stringify(res.data.result, null, 2)) 
          })
        })
